...
if(BUILD_NAO)
  ...
  set_property(TARGET Nao PROPERTY XCODE_ATTRIBUTE_CODE_SIGNING_ALLOWED "NO")
  set_property(TARGET Nao PROPERTY XCODE_ATTRIBUTE_CODE_SIGNING_REQUIRED "NO")
  target_include_directories(Nao PRIVATE "${NAO_ROOT_DIR}")
  target_include_directories(Nao SYSTEM PRIVATE "${BHUMAN_PREFIX}/Util/span-lite/include")
  target_include_directories(Nao SYSTEM PRIVATE "${BHUMAN_PREFIX}/Util/bitpacker/include/bitpacker")
  target_include_directories(Nao SYSTEM PRIVATE "${BHUMAN_PREFIX}/Util/bitproto/lib/c")
  ...
  target_include_directories(Nao SYSTEM PRIVATE "${BHUMAN_PREFIX}/Util/rapidcsv")
  if(APPLE)
