...
### Regognizer
Ab Zeile 155 wird Mittels SystemCall::say wird für jeden Roboter und jede mögliche message im Muster: "message"+ nummer der message + "robot" + nummer des sendenden roboters ausgegeben.
...
Erstellen einer Configabhängigen API um eine Interaktion mit den restlichen Modulen des Roboters zu ermöglichen. 
