...
{
public:
	void update(TIPlayback& worldModelPlayback) override;

	/**
	 * @brief This function prints all loaded worldmodel and playback files
	 */
	void printLoadedData(TIPlayback& worldModelPlayback);
	 ...
	 */
	void loadTeachInData(TIPlayback& worldModelPlayback);
	 ...
	 * @param worldModelPlayback The worldModelPlayback aggregates both structures
	 */
	void enforceConsistency(TIPlayback& worldModelPlayback);
	 ...
	 */
	bool loadWorldModel(TIPlayback& worldModelPlayback, std::string name, std::string path);
	 ...
	 */
	bool loadPlayback(TIPlayback& worldModelPlayback, std::string name, std::string path);
};
