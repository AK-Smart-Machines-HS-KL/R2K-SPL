/**
 * @file SidelineTrainerBotCard.cpp
 * @author Wilhelm Simus
 * @version 0.1
 * @date 2024-11-13
 * @brief Ein Derivat der Pointing Card für einen Roboter, der am Feldrand steht und zusieht.
 */
...
class SidelineTrainerBotCard : public SidelineTrainerBotCardBase
{
private:
  bool isActive = true;
...
MAKE_CARD(SidelineTrainerBotCard);