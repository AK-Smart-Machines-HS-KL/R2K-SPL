...
class GoalieDiveCard : public GoalieDiveCardBase
{
  ...
  void execute() override
  {
    ...
    theInterceptBallSkill((unsigned)(bit(Interception::jumpRight) | bit(Interception::jumpLeft) | bit(Interception::walk) | bit(Interception::stand) | bit(Interception::genuflectStand)), true, false);
  }
};
