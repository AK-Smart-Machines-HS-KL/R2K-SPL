...
private:
  ...
  unsigned lastTimeNotInStandWalkKick;          /**< Timestamp to keep track of the time during which the robot was either standing, walking, or kicking. Used to prevent side flips after getup. */
